...
class Data(Dataset):
    def __init__(self, cfg, model_name):
        ...
        self.trainsize  = cfg.trainsize or 384
        self.resize     = Resize(self.trainsize, self.trainsize)
        ...
        image_folder = cfg.image_folder or 'Image'
        mask_folder = cfg.mask_folder or 'GT'
        self.image_dir = cfg.image_dir or os.path.join(cfg.datapath, image_folder)
        self.mask_dir = cfg.mask_dir or os.path.join(cfg.datapath, mask_folder)
        self.samples = sorted([
