...
class Network(nn.Module):
    ...
    def __init__(self, channel=32, imagenet_pretrained=True, in_channels=3):
        super(Network, self).__init__()
        # ---- ResNet Backbone ----
        self.resnet = res2net50_v1b_26w_4s(pretrained=imagenet_pretrained, in_channels=in_channels)
