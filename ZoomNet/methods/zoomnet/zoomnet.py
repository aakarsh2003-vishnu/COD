...
class ZoomNet(BasicModelClass):
    def __init__(self, in_chans=3):
        super().__init__()
        self.shared_encoder = timm.create_model(model_name="resnet50", pretrained=False, in_chans=in_chans, features_only=True) # do pretrained=True to activate ImageNet backbone
...
@MODELS.register()
class ZoomNet_MSI8(ZoomNet):
    def __init__(self):
        super().__init__(in_chans=8)
